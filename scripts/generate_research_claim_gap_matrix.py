...
GAP_PLAN: dict[str, dict[str, object]] = {
    "local_artifact_validity": {
        ...
        "package": "Hosted QA evidence, independent timing, completed non-author task reviews, broader accepted-task scale, and real scaffold sweeps if this wording is upgraded beyond local artifact validity.",
        "exit": "The local-only caveat can be relaxed only after hosted QA, independent timing, accepted-task review, accepted-count, and scaffold-sweep gates are all supported.",
        "artifacts": [
    ...
    "research_report_scope": {
        ...
        "package": "Accepted-core provider sweeps, independent timing observations, completed non-author task reviews, hosted QA findings/dispositions, and regenerated claim audits.",
        "exit": "The report may make stronger empirical conclusions only when provider, timing, task-review, and hosted-QA evidence are committed and claim-conformance remains passing.",
        "artifacts": [
    ...
    "accepted_core_quality": {
        ...
        "package": "20-50 hard-reviewed accepted tasks, stronger T3/T4 coverage, independent Lean-human timing, completed non-author task-quality reviews, and refreshed per-task review.",
        "exit": "Accepted-core quality can support benchmark-level aggregates only after scale, depth, independent timing, and completed independent task-review evidence are supported.",
        "artifacts": [
    ...
    "locked_benchmark_status": {
        ...
        "package": "20-50 accepted tasks, T2/T3/T4 depth, independent timing, completed non-author task-quality reviews, completed scaffold/provider sweeps, hosted QA, settled findings, and frozen exact public versions.",
