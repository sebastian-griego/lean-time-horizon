...
SECTION_SPECS = [
    ...
    {
        "section_id": "report_count_consistency",
        "heading": "Report Count Consistency Audit",
        "source_artifacts": [
            "data/report_count_consistency_audit.csv",
        ...
        "required_phrases": [
            "repeated top-line counts",
            "committed CSV/JSON sources",
            "drift detector",
            "not a new benchmark-evidence source",
        ],
        "limitation": "Count consistency prevents stale report numbers; it does not make the underlying sample sizes sufficient.",
