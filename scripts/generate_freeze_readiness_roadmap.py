...
def build_rows() -> list[dict[str, str]]:
    ...
    rows.append(row(
        ...
        ["data/task_metadata.csv", "reports/accepted_task_review.md", "reports/task_quality_matrix.md", "reports/candidate_pruning_audit.md", "reports/accepted_task_cards.md"],
    ))
    rows.append(row(
        "time_horizon_depth",
        "task_portfolio",
