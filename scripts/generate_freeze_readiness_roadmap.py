...
def build_rows() -> list[dict[str, str]]:
    ...
    rows.append(row(
        ...
        f"{requirement(requirements, 'frontier_model_evidence')}; {requirement(requirements, 'model_sweep_execution_packet')}; {requirement(requirements, 'model_evidence_provenance_audit')}; {requirement(requirements, 'transcript_review_packet')}",
