...
def build_rows() -> list[dict[str, str]]:
    ...
    rows.append(row(
        ...
        f"{evidence(reqs, 'evaluation_protocol_plan')}; {evidence(reqs, 'model_sweep_execution_packet')}; {evidence(reqs, 'model_sweep_coverage_audit')}; {evidence(reqs, 'passk_claim_boundary_audit')}; {evidence(reqs, 'scaffold_result_comparison')}; {evidence(reqs, 'provider_readiness_audit')}; {evidence(reqs, 'statistical_reporting_audit')}; primary plan coverage: {compact_json(primary_coverage)}",
    ...
    rows.append(row(
        ...
        "unsupported",
        "none",
        f"{evidence(reqs, 'frontier_model_evidence')}; {evidence(reqs, 'model_sweep_execution_packet')}; {evidence(reqs, 'model_result_analysis')}; {evidence(reqs, 'provider_readiness_audit')}; {evidence(reqs, 'statistical_reporting_audit')}",
