...
def build_rows() -> list[dict[str, str]]:
    ...
    rows.append(row(
        ...
        f"{claim_evidence(claims, 'accepted_core_reviewed')}; {req_evidence(reqs, 'portfolio_accepted_count')}; {req_evidence(reqs, 'candidate_pruning_audit')}; {req_evidence(reqs, 'accepted_task_cards')}; {req_evidence(reqs, 'diagnostic_coverage_audit')}; {req_evidence(reqs, 'construct_validity_matrix')}",
