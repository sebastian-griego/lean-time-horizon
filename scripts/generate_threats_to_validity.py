...
def build_rows() -> list[dict[str, str]]:
    ...
    rows = [
        ...
        row(
            ...
            "Hosted QA readiness audit separates local readiness, packaging-scaffold readiness, hidden-material isolation risk, and missing hosted evidence.",
            "Prove hidden-material isolation, replace template image placeholders with immutable uploaded digests, run Full Env QA/Env Linter on exact problem versions, and commit findings/dispositions.",
