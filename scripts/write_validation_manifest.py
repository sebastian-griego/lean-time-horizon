...
HASHED_ARTIFACTS = [
    ...
    "data/hidden_check_inventory.csv",
    ...
    "scripts/generate_candidate_pruning_audit.py",
    "scripts/generate_accepted_task_cards.py",
    "scripts/audit_diagnostic_coverage.py",
    "scripts/generate_construct_validity_matrix.py",
    ...
    "scripts/generate_claim_authorization_matrix.py",
    "scripts/generate_research_claim_gap_matrix.py",
    "scripts/audit_report_claim_conformance.py",
    "scripts/audit_report_source_traceability.py",
    "scripts/audit_report_count_consistency.py",
    "scripts/audit_final_delivery_checklist.py",
    "scripts/audit_regeneration_commands.py",
    ...
    "scripts/generate_peer_review_matrix.py",
    ...
    "scripts/generate_statistical_analysis_plan.py",
    "scripts/generate_model_sweep_packet.py",
    "scripts/analyze_model_results.py",
    "scripts/audit_model_sweep_coverage.py",
    "scripts/generate_analysis_decision_register.py",
    "scripts/generate_evidence_strength_matrix.py",
    "scripts/generate_protocol_deviation_log.py",
    "scripts/audit_passk_claim_boundaries.py",
    "scripts/audit_model_evidence_provenance.py",
