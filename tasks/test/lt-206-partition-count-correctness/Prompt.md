...
You may add helper lemmas, but do not change the public theorem names, imports,
or weaken their statements. The intended implementation partitions a list around a pivot:
