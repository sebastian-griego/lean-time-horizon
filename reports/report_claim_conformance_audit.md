...
| `report_length_and_appendix_boundary` | main_report | pass | main report line_count=412; markdown_table_rows=141; evidence_appendix_exists=True; evidence_appendix_line_count=1435 | `[]` | Keep the main report skimmable and keep row-level generated tables in reports/evidence_appendix.md. |
