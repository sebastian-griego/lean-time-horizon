...
| `lt-204` | accepted_core_retained | `theorem_decomposition`, `invariant_design`, `long_horizon_construction` | _none_ | family=invariant_verification_ml_optimization; bucket=T2; proof_lines=36; pins=semantic; wrongs=2; diagnostic=high | task_level_internal_review | task-level evidence only; aggregate claims still require more accepted tasks and model data |
| `lt-205` | accepted_core_retained | `theorem_decomposition`, `long_horizon_construction` | _none_ | family=small_formal_library_construction; bucket=T3; proof_lines=42; pins=semantic; wrongs=2; diagnostic=high | task_level_internal_review | task-level evidence only; aggregate claims still require more accepted tasks and model data |
