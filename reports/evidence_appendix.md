...
| `concise_report_scope_and_length` | concise_report | pass | concise report exists=True; line_count=196; missing_scope_phrases=[] | Regenerate scripts/generate_concise_report.py and keep the reviewer-facing report concise and claim-bounded. |
...
| `report_length_and_appendix_boundary` | main_report | pass | main report line_count=367; markdown_table_rows=123; evidence_appendix_exists=True; evidence_appendix_line_count=1356 | Keep the main report skimmable and keep row-level generated tables in reports/evidence_appendix.md. |
...
| `skimmability` | Is the main report skimmable? | answered | concise_report_lines=196; conformance_failures=0 | The concise report is short, and row-level generated tables live in the evidence appendix instead of the main narrative. | Keep the concise and main reports short and keep long tables in generated appendices. |
...
- `required_for_research_report`: supported 40
...
Generated at UTC: `2026-06-01T16:27:48.167585+00:00`

Git branch/head at generation: `main` / `6fe2c58dc87a`. Worktree status at generation: `38 pre-commit path(s) recorded`. The exact status lines are kept in the JSON manifest because this file is generated before the final commit.
...
24. `python scripts/generate_reviewer_reproduction_packet.py`
25. `python scripts/audit_provider_readiness.py`
26. `python scripts/generate_report.py`
27. `python scripts/audit_report_source_traceability.py`
28. `python scripts/export_public_tasks.py --out public_tasks`
29. `python scripts/validate_public_export.py --out public_tasks`
30. `python scripts/audit_hosted_qa_readiness.py`
31. `python scripts/generate_task_asset_manifest.py --public-export public_tasks`
32. `python scripts/audit_prompt_contracts.py`
33. `python scripts/audit_scaffold_support.py`
34. `python scripts/generate_threats_to_validity.py`
35. `python scripts/audit_requirement_coverage.py --public-export public_tasks`
36. `python scripts/audit_claim_evidence.py`
37. `python scripts/generate_claim_authorization_matrix.py`
38. `python scripts/generate_research_claim_gap_matrix.py`
39. `python scripts/generate_concise_report.py`
40. `python scripts/audit_report_claim_conformance.py`
41. `python scripts/audit_report_shape.py`
42. `python scripts/generate_release_decision_log.py`
43. `python scripts/generate_freeze_readiness_roadmap.py`
44. `python scripts/audit_scaffold_support.py`
...
62. `python scripts/generate_release_decision_log.py`
63. `python scripts/generate_freeze_readiness_roadmap.py`
...
67. `python scripts/audit_report_source_traceability.py`
...
| `README.md` | `a7089b8dfdf6` |  | 17654 |
| `docs/axiom_policy.md` | `0adf66f9085a` |  | 712 |
| `data/benchmark_requirements.csv` | `b5cc31bcd08e` | 63 | 15303 |
...
| `data/claim_evidence_audit.csv` | `fb646bd3b60a` | 9 | 19388 |
| `data/claim_authorization_matrix.csv` | `e9b32b42d39c` | 12 | 15101 |
| `data/research_claim_gap_matrix.csv` | `aded33fdfd48` | 12 | 15161 |
| `data/report_claim_conformance_audit.csv` | `7c5771c1d1e7` | 10 | 3258 |
| `data/report_source_traceability.csv` | `4fd51eaa11a2` | 28 | 11689 |
| `data/report_shape_audit.csv` | `e28b8e863dfb` | 7 | 3350 |
| `data/figure_manifest.csv` | `41b703492d89` | 10 | 5376 |
| `data/data_schema_manifest.csv` | `0d99c6d6bef6` | 8 | 3297 |
| `data/reviewer_reproduction_steps.csv` | `74a486bce1b2` | 14 | 8151 |
| `data/release_decision_log.csv` | `bcb8d8caf14e` | 8 | 10296 |
| `data/freeze_readiness_roadmap.csv` | `4bb2a414b742` | 10 | 11654 |
| `data/scaffold_support_audit.csv` | `5c97c5fb587a` | 11 | 3994 |
| `data/requirement_coverage.csv` | `c4d1301215c8` | 63 | 24036 |
...
| `reports/claim_evidence_audit.md` | `0cccdf0c2d92` |  | 6145 |
| `reports/claim_authorization_matrix.md` | `893a1c8e489e` |  | 7712 |
| `reports/research_claim_gap_matrix.md` | `15c229ceeaf0` |  | 10940 |
| `reports/report_claim_conformance_audit.md` | `e28ffae8b11b` |  | 3547 |
| `reports/report_source_traceability.md` | `f48324e72496` |  | 12466 |
| `reports/report_shape_audit.md` | `23e17322250c` |  | 3373 |
| `reports/figure_manifest.md` | `b39eb8a92c4c` |  | 6198 |
| `reports/data_schema_manifest.md` | `b8035aeb88e7` |  | 3909 |
| `reports/reviewer_reproduction_packet.md` | `1e66b47d996c` |  | 5371 |
| `reports/concise_metr_report.md` | `25c99786095f` |  | 16278 |
| `reports/release_decision_log.md` | `c6d44da74392` |  | 10887 |
...
| `reports/requirement_coverage.md` | `f45ef22ab3b6` |  | 21847 |
...
| `scripts/audit_claim_evidence.py` | `9daf5766305a` |  | 17840 |
| `scripts/generate_claim_authorization_matrix.py` | `aee2cbe9d993` |  | 21912 |
...
| `scripts/audit_report_source_traceability.py` | `35c8ffb8d20d` |  | 25456 |
| `scripts/audit_figure_manifest.py` | `9d1717d9a6ff` |  | 11955 |
| `scripts/audit_data_schema_manifest.py` | `352227d072e5` |  | 17332 |
| `scripts/generate_reviewer_reproduction_packet.py` | `0ac334556709` |  | 17760 |
| `scripts/generate_concise_report.py` | `5e8c3df14bfe` |  | 18976 |
| `scripts/audit_report_shape.py` | `c05401fcd5b5` |  | 11123 |
| `scripts/generate_release_decision_log.py` | `59736d4906cb` |  | 15795 |
| `scripts/generate_freeze_readiness_roadmap.py` | `c019fc3b3f51` |  | 19672 |
| `scripts/audit_scaffold_support.py` | `4e8cab1a8f2b` |  | 15866 |
| `scripts/audit_requirement_coverage.py` | `cf8033610d51` |  | 112491 |
...
| `scripts/generate_report.py` | `776f2a3059b7` |  | 114108 |
...
| `scripts/audit_validation_manifest.py` | `f58b53b65e46` |  | 12302 |
| `scripts/write_validation_manifest.py` | `be49be5f161f` |  | 16384 |
...
| `regeneration_command_coverage` | commands | pass | commands=70; required=26; missing=[] | Command coverage proves the intended local gate is listed, not that it was run on a clean hosted environment. |
| `artifact_hash_integrity` | artifact_hashes | pass | artifacts=144; checked_hashes=144; hash_mismatches=0; missing_recorded_paths=0; examples=[] | The manifest hashes generated local artifacts but intentionally avoids self-referential report hashes. |
...
| `git_snapshot_policy` | git_state | pass | dirty=True; status_entries=38; policy_note_present=True | A dirty generation-time snapshot is expected for committed report updates; this is not a clean-checkout proof. |
