...
| `concise_report_scope_and_length` | concise_report | pass | concise report exists=True; line_count=199; missing_scope_phrases=[] | Regenerate scripts/generate_concise_report.py and keep the reviewer-facing report concise and claim-bounded. |
...
| `report_length_and_appendix_boundary` | main_report | pass | main report line_count=389; markdown_table_rows=133; evidence_appendix_exists=True; evidence_appendix_line_count=1381 | Keep the main report skimmable and keep row-level generated tables in reports/evidence_appendix.md. |
...
| `skimmability` | Is the main report skimmable? | answered | concise_report_lines=199; conformance_failures=0 | The concise report is short, and row-level generated tables live in the evidence appendix instead of the main narrative. | Keep the concise and main reports short and keep long tables in generated appendices. |
...
- `required_for_research_report`: supported 41
...
Generated at UTC: `2026-06-01T18:05:39.292399+00:00`

Git branch/head at generation: `main` / `a9ec9c117165`. Worktree status at generation: `40 pre-commit path(s) recorded`. The exact status lines are kept in the JSON manifest because this file is generated before the final commit.
...
6. `python scripts/audit_diagnostic_coverage.py`
7. `python scripts/generate_construct_validity_matrix.py`
8. `python scripts/audit_human_time_calibration.py`
9. `python scripts/generate_human_timing_packet.py`
10. `python scripts/record_local_qa_results.py`
11. `python scripts/generate_transcript_review_packet.py`
12. `python scripts/audit_failure_label_reviews.py`
13. `python scripts/audit_pin_coverage.py`
14. `python scripts/audit_run_integrity.py`
15. `python scripts/audit_grader_hardening.py`
16. `python scripts/generate_evaluation_protocol.py`
17. `python scripts/generate_statistical_analysis_plan.py`
18. `python scripts/generate_model_sweep_packet.py`
19. `python scripts/analyze_model_results.py`
20. `python scripts/audit_model_evidence_provenance.py`
21. `python scripts/generate_report.py`
22. `python scripts/audit_statistical_reporting.py`
23. `python scripts/audit_figure_manifest.py`
24. `python scripts/audit_data_schema_manifest.py`
25. `python scripts/generate_reviewer_reproduction_packet.py`
26. `python scripts/run_clean_workspace_replay.py`
27. `python scripts/audit_provider_readiness.py`
28. `python scripts/generate_report.py`
29. `python scripts/audit_report_source_traceability.py`
30. `python scripts/export_public_tasks.py --out public_tasks`
31. `python scripts/validate_public_export.py --out public_tasks`
32. `python scripts/audit_hosted_qa_readiness.py`
33. `python scripts/generate_task_asset_manifest.py --public-export public_tasks`
34. `python scripts/audit_prompt_contracts.py`
35. `python scripts/audit_scaffold_support.py`
36. `python scripts/generate_threats_to_validity.py`
37. `python scripts/audit_requirement_coverage.py --public-export public_tasks`
38. `python scripts/audit_claim_evidence.py`
39. `python scripts/generate_claim_authorization_matrix.py`
40. `python scripts/generate_research_claim_gap_matrix.py`
41. `python scripts/generate_concise_report.py`
42. `python scripts/audit_report_claim_conformance.py`
43. `python scripts/audit_report_shape.py`
44. `python scripts/generate_release_decision_log.py`
45. `python scripts/generate_freeze_readiness_roadmap.py`
46. `python scripts/audit_scaffold_support.py`
47. `python scripts/audit_requirement_coverage.py --public-export public_tasks`
48. `python scripts/audit_claim_evidence.py`
49. `python scripts/generate_claim_authorization_matrix.py`
50. `python scripts/generate_research_claim_gap_matrix.py`
51. `python scripts/generate_concise_report.py`
52. `python scripts/audit_report_claim_conformance.py`
53. `python scripts/audit_report_shape.py`
...
64. `python scripts/generate_release_decision_log.py`
65. `python scripts/generate_freeze_readiness_roadmap.py`
66. `python scripts/write_validation_manifest.py --public-export public_tasks`
67. `python scripts/audit_validation_manifest.py`
68. `python scripts/generate_report.py`
69. `python scripts/audit_report_source_traceability.py`
70. `python scripts/write_validation_manifest.py --public-export public_tasks`
71. `python scripts/audit_validation_manifest.py`
72. `python scripts/generate_report.py`
...
| `README.md` | `e116fd91b566` |  | 18021 |
| `docs/axiom_policy.md` | `0adf66f9085a` |  | 712 |
| `data/benchmark_requirements.csv` | `6f9913ef32ab` | 64 | 15621 |
...
| `data/threats_to_validity.csv` | `5b717d5db203` | 12 | 6073 |
...
| `data/claim_evidence_audit.csv` | `6789b5c0aa9d` | 9 | 19574 |
| `data/claim_authorization_matrix.csv` | `e84a3ae11141` | 12 | 15169 |
| `data/research_claim_gap_matrix.csv` | `3b338d7f9406` | 12 | 15161 |
| `data/report_claim_conformance_audit.csv` | `a8dd43911b1b` | 10 | 3258 |
| `data/report_source_traceability.csv` | `a5f19ab2acd7` | 28 | 11791 |
| `data/report_shape_audit.csv` | `3c12963f2942` | 7 | 3350 |
| `data/figure_manifest.csv` | `41b703492d89` | 10 | 5376 |
| `data/data_schema_manifest.csv` | `20a0afd120e2` | 8 | 3297 |
| `data/reviewer_reproduction_steps.csv` | `0be804f614cf` | 15 | 8678 |
| `data/clean_workspace_replay.csv` | `be2899712c87` | 7 | 3641 |
| `data/release_decision_log.csv` | `7c18affabafe` | 8 | 10412 |
| `data/freeze_readiness_roadmap.csv` | `f87d25b016f7` | 10 | 11804 |
| `data/scaffold_support_audit.csv` | `5c97c5fb587a` | 11 | 3994 |
| `data/requirement_coverage.csv` | `3412c4327eee` | 64 | 24452 |
...
| `reports/claim_evidence_audit.md` | `6bd1937d0c19` |  | 6270 |
| `reports/claim_authorization_matrix.md` | `893a1c8e489e` |  | 7712 |
| `reports/research_claim_gap_matrix.md` | `6041c5e4d90a` |  | 10940 |
| `reports/report_claim_conformance_audit.md` | `299c323ab690` |  | 3547 |
| `reports/report_source_traceability.md` | `9c7b233f5479` |  | 12568 |
| `reports/report_shape_audit.md` | `32cbecda54b1` |  | 3373 |
| `reports/figure_manifest.md` | `b39eb8a92c4c` |  | 6198 |
| `reports/data_schema_manifest.md` | `bed7109cc1bc` |  | 3909 |
| `reports/reviewer_reproduction_packet.md` | `f48c501206ea` |  | 5634 |
| `reports/clean_workspace_replay.md` | `a7727d6727df` |  | 2739 |
| `reports/concise_metr_report.md` | `91e680a80fd6` |  | 16526 |
| `reports/release_decision_log.md` | `7cad482fabf6` |  | 11003 |
| `reports/freeze_readiness_roadmap.md` | `0899eec82944` |  | 5872 |
...
| `reports/requirement_coverage.md` | `087cc5e26a44` |  | 22200 |
...
| `scripts/audit_claim_evidence.py` | `36b6ea44f28e` |  | 17999 |
| `scripts/generate_claim_authorization_matrix.py` | `4320a8d8bf91` |  | 22010 |
| `scripts/generate_research_claim_gap_matrix.py` | `d7fa945eb510` |  | 16894 |
| `scripts/audit_report_claim_conformance.py` | `57519b084e6b` |  | 16193 |
| `scripts/audit_report_source_traceability.py` | `9926c41cd6a1` |  | 25687 |
| `scripts/audit_figure_manifest.py` | `9d1717d9a6ff` |  | 11955 |
| `scripts/audit_data_schema_manifest.py` | `352227d072e5` |  | 17332 |
...
| `scripts/generate_concise_report.py` | `88dbb05ac99b` |  | 19611 |
| `scripts/audit_report_shape.py` | `c05401fcd5b5` |  | 11123 |
| `scripts/generate_release_decision_log.py` | `b29939c24dca` |  | 15855 |
| `scripts/generate_freeze_readiness_roadmap.py` | `5e4537534515` |  | 19786 |
| `scripts/audit_scaffold_support.py` | `4e8cab1a8f2b` |  | 15866 |
| `scripts/audit_requirement_coverage.py` | `9305443dde2a` |  | 114635 |
...
| `scripts/generate_threats_to_validity.py` | `b9c5e4fc14e4` |  | 18764 |
...
| `scripts/generate_report.py` | `05c092e08bbe` |  | 115955 |
...
| `scripts/audit_validation_manifest.py` | `98abdb37275a` |  | 12380 |
| `scripts/write_validation_manifest.py` | `4d6d0b32ddc2` |  | 16587 |
...
| `regeneration_command_coverage` | commands | pass | commands=72; required=28; missing=[] | Command coverage proves the intended local gate is listed, not that it was run on a clean hosted environment. |
| `artifact_hash_integrity` | artifact_hashes | pass | artifacts=147; checked_hashes=147; hash_mismatches=0; missing_recorded_paths=0; examples=[] | The manifest hashes generated local artifacts but intentionally avoids self-referential report hashes. |
...
| `git_snapshot_policy` | git_state | pass | dirty=True; status_entries=40; policy_note_present=True | A dirty generation-time snapshot is expected for committed report updates; this is not a clean-checkout proof. |
