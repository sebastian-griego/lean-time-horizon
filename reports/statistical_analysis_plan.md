...
- accepted tasks: `6`
- planned accepted task/scaffold cells: `0`
...
| `v0_1_primary_descriptive_performance` | blocked | accepted=6; cells=0; k=10; scaffolds=3; group_n=not_applicable; timing=0; failure_reviews=all non-success transcripts reviewed; hosted=false | Coverage table and blocked performance statement. | Do not report aggregate pass@k estimates or intervals for accepted-core performance until every planned cell is covered. |
