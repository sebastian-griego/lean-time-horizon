...
By default, the export includes `accepted_v0`, `calibration_only`, and any `candidate_review_pending` tasks. It excludes hidden references and wrong submissions, copies every metadata-listed public file, validates exported Lean compilation, and can be followed by the security/leakage audit for committed/exported credential and hidden-content scans.
